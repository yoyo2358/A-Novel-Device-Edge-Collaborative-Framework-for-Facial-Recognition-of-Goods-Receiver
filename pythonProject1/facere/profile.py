...
# 加载所有待测试的图片
test_images1 = os.listdir('test_face2')

#将数据库正脸和测试的所有侧脸图片编码存入列表中
...
print(data_image_encode_array.shape)
...
print("侧脸单视图人脸识别率："+ str(round(correct_rate,3)) + "%")